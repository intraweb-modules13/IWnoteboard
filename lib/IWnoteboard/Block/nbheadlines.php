 ...
 */
function IWnoteboard_nbheadlinesblock_init()
{
 ...
 */
function IWnoteboard_nbheadlinesblock_info()
{
 ...
 */
function IWnoteboard_nbheadlinesblock_display($row)
{
	...
	foreach ($registres as $registre) {
		...
		if(($registre['verifica'] == 1 &&
			...
			if($tema == ""){$tema = $this->__('Topic not found');}
