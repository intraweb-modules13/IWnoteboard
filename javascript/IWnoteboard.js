function noteboardIsShared(sid){
	...
	var pars = "module=IWnoteboard&func=createSharedURL&public=" + public;
...
function regenSharedURL(text){
	...
	if(resposta){
		...
		var pars = "module=IWnoteboard&func=regenSharedURL";
		var myAjax = new Ajax.Request("ajax.php", 
		{
			method: 'get', 
			parameters: pars, 
...
function deltopic(tid,text,authid){
	...
	if(resposta){
		...
		var pars = "module=IWnoteboard&func=deletetopic&tid=" + tid + "&authid=" + authid;
		var myAjax = new Ajax.Request("ajax.php", 
		{
			method: 'get', 
			parameters: pars, 
...
function delShared(pid,text,authid){
	...
	if(resposta){
		...
		var pars = "module=IWnoteboard&func=deleteShared&pid=" + pid + "&authid=" + authid;
		var myAjax = new Ajax.Request("ajax.php", 
		{
			method: 'get', 
			parameters: pars, 
