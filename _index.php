...
if (!SecurityUtil::checkPermission*(0, 'IWnoteboard::', '::', ACCESS_READ)) {
    echo $this->__('Invalid \'authkey\':  this probably means that you pressed the \'Back\' button, or that the page \'authkey\' expired. Please refresh the page and try again.');
    include 'footer.php';
    exit;
}

//Carreguem les funcions de l'usuari
if (!ModUtil::load('IWnoteboard', 'user')) {
	echo $this->__('Error! Could not load module.');
	include 'footer.php';
	exit;
}

$llistat=ModUtil::func('IWnoteboard','user','main');
